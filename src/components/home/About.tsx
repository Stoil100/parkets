            ...
            <div className="mx-auto max-w-5xl px-4 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4 text-base leading-relaxed text-gray-700">
                    <p>
                        ...
                        . Нашият екип от професионалисти съчетава прецизност,
                        стил и дългогодишен опит, за да превърне всяко
                        пространство в съвършено завършен детайл.
                    </p>
                    <p>
                        Използваме само{' '}
                        <span className="text-golden underline-offset-2 hover:underline cursor-pointer">
                        ...
                        , които осигуряват дълготрайност, естетика и лесна
                        поддръжка — независимо дали става дума за дом, офис или
                        индустриален обект.
                    </p>
                    <p className="italic text-gray-600">
                        ...
                        създава повърхности, които впечатляват – с безупречно
                        изпълнение и елегантно присъствие във всеки проект.
                    </p>
                </div>
                <Link
                    href="/about"
