...
export function ParallaxSection() {
    ...
    const topImages = [
        '/images/parallax/top/1.jpg',
        '/images/parallax/top/2.jpg',
        '/images/parallax/top/3.jpg',
        '/images/parallax/top/4.jpg',
        '/images/parallax/top/5.jpg',
        '/images/parallax/top/6.jpg',
    ];

    const bottomImages = [
        '/images/parallax/bottom/1.jpg',
        '/images/parallax/bottom/2.jpg',
        '/images/parallax/bottom/3.jpg',
        '/images/parallax/bottom/4.jpg',
        '/images/parallax/bottom/5.jpg',
        '/images/parallax/bottom/6.jpg',
    ];
        ...
        >
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-1">
                    Пространства, превърнати в изкуство
                </h2>
                <p className="text-muted-foreground text-lg">
                    Истински проекти, създадени с внимание към всеки детайл.
                </p>
            </div>
                ...
                >
                    {bottomImages.map((src, index) => (
                        ...
                        >
                            <img
                                src={src || '/placeholder.svg'}
                                alt={`Gallery image ${topImages.length + index + 1}`}
                                className="object-cover w-full h-full"
                            />
                        </div>
                    ))}
