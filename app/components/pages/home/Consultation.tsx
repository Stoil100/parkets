        ...
        <Card className="bg-transparent p-0 shadow-none border-0">
          <CardContent className="flex flex-col gap-20 lg:flex-row lg:items-center lg:p-10">
            ...
            <div className="flex w-full flex-col gap-4 lg:w-[52%]">
              ...
              <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
                По време на консултацията обсъждаме бюджета, целите, техниките и
                изискванията, за да изберем най-подходящото решение за вашето
                пространство. Нашите специалисти представят на място различни
                типове покрития, като демонстрират реални мостри и завършени
                ефекти.
              </p>
              ...
              <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
                ...
                <span className="font-semibold text-gray-900">
                  индивидуално – в съответствие с вашите желания, срокове и
                  бюджет
                </span>
                . Целта ни не е просто да изпълним задача, а да създадем
                повърхности, които впечатляват и издържат във времето.
              </p>
            </div>
          </CardContent>
        </Card>
