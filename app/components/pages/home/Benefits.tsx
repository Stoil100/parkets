        ...
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-start">
          <div className="max-w-md">
            <h2 className="text-3xl font-extrabold leading-tight text-gray-900 md:text-4xl">
              Какво получаваме с<span className="block">Royal Decorators</span>
            </h2>
          </div>

          <p className="max-w-md text-base leading-relaxed text-gray-700 md:text-right">
            С иновация, прецизност и внимание към детайла превръщаме всяко
            пространство в дълготрайна и елегантна среда.
          </p>
        </div>
